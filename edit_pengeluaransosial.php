...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $keluar = $_POST['keluar'];
    $sql = "UPDATE kas_sosial SET tgl_ks = '$tgl_ks', keterangan_ks = '$keterangan_ks', keluar = '$keluar' WHERE id_ks = $id";
    if (mysqli_query($conn, $sql)) {
        header("Location: pengeluaran_sosial.php");
        exit; 
    } else {
...
<body>
    <h2>Edit Data Pengeluaran Sosial</h2>
