...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE kas_masjid SET tgl_km = '$tgl_km', keterangan_km = '$keterangan_km', masuk = '$masuk' WHERE id_km = $id";
...
<head>
    ...
    <title>Edit Pemasukan Masjid</title>
...
<body>
    <h2>Edit Data Pemasukan Masjid</h2>
